...
<section class="w-full md:max-w-[50%] h-screen p-16">
	...
	<p>Vercel Inc.<br />
		440 N Barranca Ave Pmb<br />
		4133 Covina, CA<br />
		91723-1722 United States</p>
	<h2 class="mt-4">3. Allgemeine Hinweise und Pflicht&shy;informationen</h2>
	...
	<h2 class="mt-4">4. Datenerfassung auf dieser Website</h2>
	...
	<p>Beim Besuch dieser Website kann Ihr Surfverhalten statistisch ausgewertet werden. Das geschieht vor allem mit sogenannten Analyseprogrammen.</p>
	...
	<ul class="list-disc list-inside py-4 text-sm">
		...
		<li>
			<a href="https://www.vertretungsapp.de" class="text-primary">https://www.vertretungsapp.de</a>
		</li>
		<li>
			<a href="https://app.vertretungsapp.de" class="text-primary">https://app.vertretungsapp.de</a>
		</li>
	</ul>
